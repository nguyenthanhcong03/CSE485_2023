  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="http://localhost:3000/login.php">Đăng nhập</a>
        </li>
      </ul>
      <form class="d-flex" role="search">
        <input class="form-control me-2" type="search" placeholder="Nội dung cần tìm" aria-label="Tìm">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-8">
                        <h5 class="card-title mb-2">
                            <a href="http://localhost:3000/detail1.php" class="text-decoration-none">Cây và gió</a>
                        </h5>
